  ...
  describe "POST /create" do
    ...
    context "with valid params" do
      ...
      context "with an existing user_deck" do
        ...
        context "with user_deck_cards and new cards added to deck" do
          it "builds user_deck_cards for new cards only" do
            user_deck.build_user_cards
            user_deck.save

            deck.cards.create!(front: "new card", back: "new card back")

            expect { post_request }.to change(UserDeckCard, :count).by(1)
          end
        end
      end
    end
