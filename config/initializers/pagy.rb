...
if Rails.env.development?
  # Project is setup to use Manual syncing Rake task, use console command if needed below:
  # CAUTION! Syncing will overide custom changes to the files.
  # `bundle exec pagy:sync:javascript`
  # `bundle exec pagy:sync:stylesheet`

  # Pagy.sync(:stylesheet, Rails.root.join("app/assets/stylesheets"), "pagy-tailwind.css")
